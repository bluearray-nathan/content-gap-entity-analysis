...
def render_analysis_results(
    ...
    section_data = dict(results["section_data"])
    ...
    sections = list(section_data.get("must_cover_sections", []))
...
"""
        ...
        with st.expander("Top topic gaps snapshot"):
            if filtered_gap_df.empty:
                ...
                snapshot_cols = ["entity", "section_priority", "coverage_status", "competitor_prominence"]
                st.dataframe(filtered_gap_df[snapshot_cols].head(12), use_container_width=True)
    ...
    with exports_tab:
        ...
        st.download_button(
            ...
            mime="text/csv",
            help="Recommendations export including recommended sections.",
            on_click="ignore",
        )
...
if stored_results:
    render_analysis_results(
        stored_results,
        hide_competitor_brands=hide_competitor_brands,
